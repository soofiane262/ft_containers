...
template< class T > void	compare( const T ft, const T std, const std::string str, const std::string err, const int line ) {
	std::cout << str << "\tft\t: `" WHITE << ft << RESET "`\t\t" << "std\t: `" WHITE << std << RESET "`\n";
	if ( ft != std )
