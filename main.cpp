...
int	main( void ) {
...

	{
		{
			std::stringstream	ss;
			std::system( "cat main.cpp | grep 'Algorithm Test' | wc -l | awk '{print $1}' > .logs" );
		...
		printHead( "algorithm" );
		try { std::cout << MAGENTA "Algorithm Test " << ++test_idx << " of " << total_tests << RESET "\n\n";
			std::cout << TITLE "is_integral()" RESET "\n\n";
			compare( ft::is_integral< bool >::value, std::is_integral<bool >::value, "bool\t\t", "is_integral" );
			compare( ft::is_integral< char >::value, std::is_integral<char >::value, "char\t\t", "is_integral" );
			compare( ft::is_integral< char16_t >::value, std::is_integral<char16_t >::value, "char16_t\t", "is_integral" );
			compare( ft::is_integral< char32_t >::value, std::is_integral<char32_t >::value, "char32_t\t", "is_integral" );
			compare( ft::is_integral< wchar_t >::value, std::is_integral<wchar_t >::value, "wchar_t\t\t", "is_integral" );
			compare( ft::is_integral< signed char >::value, std::is_integral<signed char >::value, "signed char\t", "is_integral" );
			compare( ft::is_integral< short int >::value, std::is_integral<short int >::value, "short int\t", "is_integral" );
			compare( ft::is_integral< int >::value, std::is_integral<int >::value, "int\t\t", "is_integral" );
			compare( ft::is_integral< long int >::value, std::is_integral<long int >::value, "long int\t", "is_integral" );
			compare( ft::is_integral< long long int >::value, std::is_integral<long long int >::value, "long long int\t", "is_integral" );
			compare( ft::is_integral< unsigned char >::value, std::is_integral<unsigned char >::value, "unsigned char\t", "is_integral" );
			compare( ft::is_integral< unsigned short int >::value, std::is_integral<unsigned short int >::value, "unsigned short int", "is_integral" );
			compare( ft::is_integral< unsigned int >::value, std::is_integral<unsigned int >::value, "unsigned int\t", "is_integral" );
			compare( ft::is_integral< unsigned long int >::value, std::is_integral<unsigned long int >::value, "unsigned long int", "is_integral" );
			compare( ft::is_integral< unsigned long long int >::value, std::is_integral<unsigned long long int >::value, "unsigned long long int", "is_integral" );
			compare( ft::is_integral< float >::value, std::is_integral<float >::value, "float\t\t", "is_integral" );
			compare( ft::is_integral< double >::value, std::is_integral<double >::value, "double\t\t", "is_integral" );
			compare( ft::is_integral< long double >::value, std::is_integral<long double >::value, "long double\t", "is_integral" );
			compare( ft::is_integral< std::string >::value, std::is_integral<std::string >::value, "string\t\t", "is_integral" );
			compare( ft::is_integral< std::vector< int > >::value, std::is_integral<std::vector< int > >::value, "std::vector<int>", "is_integral" );
			compare( ft::is_integral< std::vector< char > >::value, std::is_integral<std::vector< char > >::value, "std::vector<char>", "is_integral" );
	...
	}
	{
		...
		try { std::cout << MAGENTA "Vector Test " << ++test_idx << " of " << total_tests << RESET "\n\n";
			int	size = ( rand() % 10 ) + 1;
			int	value = ( rand() % 10 ) + 1;
			std::cout << TITLE "Parametrized Constructor : vec( " << size << ", " << value << " )" RESET "\n\n";
		...
		try { std::cout << MAGENTA "Vector Test " << ++test_idx << " of " << total_tests << RESET "\n\n";
			int	n = ( rand() % 10 ) + 1;
			int	val = ( rand() % 100 ) + 1;
			std::cout << TITLE "Parametrized Constructors : vec( " << n << ", " << val << " )" << RESET "\n\n";
