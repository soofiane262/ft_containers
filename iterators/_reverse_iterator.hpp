...
namespace ft {
	...
	template< class T > class _reverse_iterator {
		...
		public:
			...
			template < class Iter >
			_reverse_iterator ( const _reverse_iterator< Iter >& rev_it ) : _iter(rev_it._iter) {};
		...
		bool	operator == ( const _reverse_iterator< Iterator >& lhs, const _reverse_iterator< Iterator >& rhs ) {
