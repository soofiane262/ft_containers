...
/*   Updated: 2023/02/18 17:30:23 by sel-mars         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class red_black_tree {
  ...
  public:
	...
	void insert( const value_type &elt ) { _insert( _root, elt ); } // insert
	void del( const value_type &elt ) { _del( _root, elt ); }		// delete
};
